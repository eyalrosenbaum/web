...
/**
 * Servlet implementation class GetNextTenThreadsDownServlet
 */
@WebServlet("/GetNextTenThreadsDownServlet")
public class GetNextTenThreadsDownServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetNextTenThreadsDownServlet() {
        super();
