...
public interface AppConstants {
	...
	public final String INSERT_SUBSCRIPTIONS = "INSERT INTO SUBSCRIPTIONS (username,channel,type,date) VALUES(?,?,?,?)";
	...
	public final String SELECT_CHANNEL_BY_NAME_AND_TYPE =  "SELECT * FROM CHANNELS WHERE NAME = ?";
	...
	public final String SELECT_THREADS_BY_CHANNEL_AND_DATE_DESC = "SELECT * FROM MESSAGES WHERE CHANNEL = ? AND ISTHREAD = TRUE AND LASTUPDATE BETWEEN ? AND ? ORDER BY LASTUPDATE ASC" ;
